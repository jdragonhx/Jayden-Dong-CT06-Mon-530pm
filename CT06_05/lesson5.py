...
# for hundred in range(51, 101):
#     print(hundred)

# **Task 5c**:
# Print numbers from 18 to 29 using a 'for' loop.
# for num1 in range(18, 30):
#     print(num1)
